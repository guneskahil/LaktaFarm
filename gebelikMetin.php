        ...
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
                ...
                <div class="d-inline-flex text-white" style="font-size: 30px;">
                    <p class="m-0 ">Gebelik Periyodu Nedir?</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="img/anneYavru.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                        <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Gebelik Periyodu</h6><br>
                        <p>Gebelik periyodu, bir ineğin dölleme (doğum) ile sonraki yeniden dölleme arasındaki zaman
                            dilimini ifade eder. İneklerde gebelik periyodu genellikle yaklaşık 280 gün (ortalama 9 ay)
                            sürer. Bu süre, ineğin gebelik süresi boyunca embriyonun gelişimini tamamlaması ve sağlıklı
                            bir yavru doğurması için gereklidir.<br><br>

                            Gebelik periyodu, ineklerin sağlıklı bir şekilde üreme sürecini tamamlaması için kritik
                            öneme sahiptir. Bu süreçte ineklerin sağlığına, beslenmesine ve bakımına özen
                            gösterilmelidir. Ayrıca, veteriner hekimler tarafından düzenli olarak yapılan muayenelerle
                            gebeliğin sağlıklı bir şekilde ilerlediği takip edilmelidir.<br><br>

                            Özetle, gebelik periyodu, ineğin dölleme ile sonraki yeniden dölleme arasındaki süredir ve
                            ineklerin üreme sürecindeki önemli bir aşamadır. Bu süreçte ineklerin sağlığına ve bakımına
                            özen gösterilmesi, sağlıklı bir doğum ve yavru ineklerin yetiştirilmesi için hayati öneme
                            sahiptir.<br><br></p>
                    </div>
                </div>
            </div>

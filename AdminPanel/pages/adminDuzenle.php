...
function adminBilgiGuncelle($id, $email, $sifre)
{
    $db = dbBaglantisi();
    ...
    if ($db instanceof PDO) {
        try {
            // SQL sorgusu
            $sql = "UPDATE admin SET admin_mail = :email, admin_sifre = :sifre WHERE admin_id = :id";
...
// Formdan gelen verileri al ve admin ekleme işlemi gerçekleştir
...
// Formdan gelen verileri al ve admin bilgi güncelleme işlemi gerçekleştir
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['guncelle'])) {
    $id = $_POST['adminİd']; // Değişiklik: adminİd yerine adminId
    $email = $_POST['emailGuncelle'];
    $sifre = $_POST['sifreGuncelle'];

    // Bilgi güncelleme
    if (adminBilgiGuncelle($id, $email, $sifre)) {
        // Başarılı bir şekilde güncellendi
        echo "Admin bilgileri güncellendi.";
    } else {
        // Güncelleme başarısız
        echo "Admin bilgileri güncellenemedi.";
    }
}
?>
    ...
    <main class="main-content  mt-0">
      <div class="page-header align-items-start min-vh-100" >
        <div class="container my-auto">
          <div class="row">
            <div class="col-lg-6 col-md-8 col-12 mx-right ">
            ...
            <div class="col-lg-6 col-md-8 col-12 mx-right ">
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                  <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Admin Bilgi Güncelle</h4>
                    <div class="row mt-3">
                    </div>
                  </div>
                </div>
                ...
                <div class="input-group input-group-outline my-3">
                   ...
                   <div class="input-group input-group-outline my-3">
                    <label class="form-label">Email</label>
                    <input type="email" name="emailGuncelle" class="form-control">
                   </div>
                   <div class="input-group input-group-outline mb-3">
                    <label class="form-label">Password</label>
                    <input type="password" name="sifreGuncelle" class="form-control">
                   </div>
                   <div class="text-center">
